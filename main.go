...
func main() {
	...
	flag.StringVar(&parameters.downwardapiCfgFile, "downwardapiCfgFile", "/etc/webhook/config/downwardapiconfig.yaml", "File containing the mutation configuration.")
	flag.Parse()

	downwardapiConfig, err := loadConfig(parameters.downwardapiCfgFile)
	if err != nil {
